...
export type SidebarRootInjected = {
  /**
   * Create and open a New Session in the explicit Workspace, the current
   * Session's Workspace, or the recent Workspace; clear into the New Session
   * pure view when none exist.
   */
