...
- **A route's catalog never refreshes itself** — the catalog is whatever `settings.yaml` says; explicit discovery only returns candidates; saving adopted entries updates the catalog.
