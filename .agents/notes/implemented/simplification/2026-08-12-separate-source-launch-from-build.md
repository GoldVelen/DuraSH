...
- Source users own artifact freshness. Missing artifacts stop startup, DuraSH and upstream Web source launches reject conflicting recorded client identities, and existing stale frontend and client-plugin bundles can still silently serve older browser code.
