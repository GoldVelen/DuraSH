...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/bundle/durash-web-profile': { kind: 'none', reason: 'The overlay mounts only the browser-side DuraSH identity package and the host-side reliability loop, and adds nothing to model requests.' },
