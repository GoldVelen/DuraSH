...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  reliabilityPolicy: 'reliability-loop.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  AcceptanceView: 'reliability-loop.md',
  TargetProbe: 'reliability-loop.md',
  EvidenceIO: 'reliability-loop.md',
  ...
  ReliabilityLaneRoute: 'reliability-loop.md',
  ReliabilityPolicyRequest: 'reliability-loop.md',
  ReliabilityPolicyConfigureRequest: 'reliability-loop.md',
  ReliabilityPolicySnapshot: 'reliability-loop.md',
  ...
  GlobalRulesDocument: 'settings.md',
  ...
  AuthorizationError: 'credentials.md',
  AuthorizationAttemptView: 'credentials.md',
  AuthorizationDescribeValue: 'credentials.md',
