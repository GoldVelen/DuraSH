...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  ReliabilityLoopStartAck: 'reliability-loop.md',
  ReliabilityLoopRef: 'reliability-loop.md',
  ReliabilityLoopStatusView: 'reliability-loop.md',
  ReliabilityLoopDetails: 'reliability-loop.md',
