...
Web development prepares current neutral Host, Client, and Web artifacts with `pnpm run build:local`, then runs the source Host and the Client plugin watcher in separate terminals:
